    ...
    render() {
        ...
        return <View style={{backgroundColor:"#fff"}}>
            ...
            <Card>
              ...
              <ButtonGroup onPress={this.updateAmt} selectedIndex={selectedAmt} buttons={loans} containerStyle={{ height: 50 }} />
            </Card>
            <Card>
              <Text style={styles.header}>PAYMENT TERMS</Text>
              <ButtonGroup onPress={this.updateTerm} selectedIndex={selectedTerm} buttons={buttons} containerStyle={{ height: 40 }} />
